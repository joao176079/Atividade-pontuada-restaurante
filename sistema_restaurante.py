...
while True:
    ...
    while True:
            ...
            if outro_prato == 1 or outro_prato == 0:
                break
            else:
...
print("\nPratos selecionados através dos códigos:")
for i, prato in enumerate(lista_dos_pratos):
    print(f"{i+1}º prato selecionado: {prato}")
